...
pdf("risk-fig.pdf", width = 7.0, height = 4.3)
# setup panel layout:
split.screen(c(1, 2))
...
par(las = 0)
mtext("Abundance or growth rate", side = 2, line = 0.5, outer = T, cex = 0.8, col = axis.col)

par(las = 1)
text(2, 0.7, expression(sigma), pos = 2, cex = 1.1, col = axis.col)
text(2, 0, expression(mu), pos = 2, cex = 1.1, col = axis.col)
text(2, -1.1, "VaR", pos = 2, cex = 1.1, col = axis.col)
text(2, -1.9, "CVaR", pos = 2, cex = 1.1, col = axis.col)
