...
- single vs. multidimensional attributes
- finance set up for single dimensional, ecological problems often aren't
- but this is a common problem; e.g. decision analysis
- solutions: maintaining multiple dimensions, condensing via multiattribute
  utility theory, using in conjunction with other management and evaluation
  criteria
...
limits, stock supplementation, or habitat restoration. Realistic re-investment
...
<!--1. Consider whether conservation problems can fit into a -->

In conclusion, we see the application of ecological portfolio concepts to
decision making as an exciting area of research that conservation biology has
just begun exploring. Ecological portfolios can apply to a wide variety of
ecological assets, ecological investors, and investment styles, but we need to
carefully consider how fundamental differences between financial and ecological
data may restrict the financial portfolio methods we can apply in conservation
biology and how we can operationalize the components of ecological portfolios
(e.g. who are the investors and assets). Ecological portfolio theory's greatest
strength may be that it unites a wide variety of ecological theories along with
concepts of risk, uncertainty, and variability. Critically, it unites these
sometimes-abstract concepts in a way that can be clearly communicated to
