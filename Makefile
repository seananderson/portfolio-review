...
anderson-etal-ecological-portfolios.pdf: anderson-etal-ecological-portfolios.tex ms.tex figs.tex theory-table.tex data-table.tex mmm-traits.pdf efficient-frontier-fig.pdf salmon-portfolios-bw.pdf risk-fig/risk-fig-bw.pdf
	latexmk $<
